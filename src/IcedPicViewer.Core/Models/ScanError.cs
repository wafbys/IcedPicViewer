...
/// <summary>
/// Reported by the directory scanner when an entry on disk was recognised
/// as a candidate (e.g. by extension) but could not actually be read. The
/// gallery skips these silently; the VM surfaces a count + first-failure
/// in the status bar so the user can identify the offending file.
/// </summary>
